<template>
  <div>
    <div class="container-scroller">
      ...
      >
        <div
          class="content-wrapper d-flex align-items-center auth auth-bg-3 theme-one"
        >
          <div class="row w-100">
      ...
      if (this.userEmail.length === 0 && this.userPass.length === 0) {
        ...
        firebase
          ...
          .catch(err => {
            console.log(err);
            this.emptyData =
              "No se encontró registro de este Mecánico por favor verifique el correo o contraseña ingresados";
          });
      }
    }
  }
