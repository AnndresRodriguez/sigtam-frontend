              ...
              <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                <div class="col-md-1">
                  <img
                    ...
                    src="../../assets/img/faces/carro.png"
                    alt="profile image"
                  />
                </div>
                <div class="ticket-details col-md-9">
                  ...
                  <p class="text-gray ellipsis mb-2">
                    Propietaria - Cliente: Angélica Bermudez
                  </p>
                  <p class="text-gray ellipsis mb-2">Cúcuta Colombia</p>
                  <div class="row text-gray d-md-flex d-none">
                    <div class="col-4 d-flex">
                      <small class="mb-0 mr-2 text-muted text-muted"
                        >Hora de Diagnostico :</small
                      >
                      <small
              ...
              <div class="fluid-container">
                <template>
                  <div
                    ...
                    v-for="falla in fallos"
                    :key="falla"
                  >
                    <div class="col-md-1">
                      <img
                        class="img-sm rounded-circle mb-4 mb-md-0"
                        src="../../assets/img/faces/icono-advertencia.png"
                        alt="profile image"
                      />
                    </div>
                    <div class="ticket-details col-md-9">
                      ...
                      <p class="text-gray ellipsis mb-2">Problema</p>
                      <p class="text-gray ellipsis mb-2">
                        {{ falla.descripcion }}
                      </p>
                    </div>
                    <div class="ticket-actions col-md-2"></div>
                  </div>
                </template>
              </div>
            </div>
    ...
    crearFallos() {
      ...
      setTimeout(() => {
        this.fallos.push({
          ...
          causa: "Posible Fuga",
          descripcion:
            "El motor no alcanza la temperatura esperada después de encendido el auto."
        });
      }, 7000);
      ...
      setTimeout(() => {
        this.fallos.push({
          ...
          descripcion:
            "El Proceso de Combustión no es normal, puede crear problemas al encender el auto"
        });
      }, 11000);
      ...
      setTimeout(() => {
        this.fallos.push({
          ...
          descripcion:
            "Motor falla en la aceleración o en baja revolución con cargas elevadas"
        });
      }, 15000);
