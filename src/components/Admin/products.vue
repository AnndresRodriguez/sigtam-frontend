        ...
        >
          ...
          <div>
            <button
              ...
              data-toggle="modal"
              data-target="#ModalAniadirProducto"
            >
              <i class="mdi mdi-account-plus"></i>Nuevo Producto
            </button>
            ...
            <button
              ...
              data-target=""
            >
              <i class="mdi mdi-account-plus"></i>Nueva Categoría
            </button>
          </div>
        </div>
      </div>
        ...
        <div class="card card-statistics">
          <div class="card-body product">
            ...
            >
              ...
              <span
                class="badge"
                :class="iconoStock(product.cantidadEnStock)"
                style="font-size: 14px"
                >{{ product.cantidadEnStock }}</span
              >
            </div>
            ...
            >
              ...
              <h6 class="font-weight-medium text-primar mb-0">
                {{ product.marca }}
              </h6>
            </div>
            ...
            <div
              class="d-flex flex-row justify-content-around align-items-center mt-2"
            >
              <button
                type="button"
                ...
                @click="crearProducto(product)"
              >
                <i class="mdi mdi-pencil"></i>
              </button>
              <button
                type="button"
                class="btn btn-icons btn-rounded btn-danger ml-3"
  ...
  methods: {
    ...
    deleteProduct(idProduct) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios
            .delete(`${constants.URL_PRODUCTOS}/${this.categoria}`, {
              params: { idProductToDelete: idProduct }
            })
            .then(res => {
