        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="fluid-container">
              <div
                class="row ticket-card mt-5 pb-2 pt-2 border-bottom border-top pb-3 mb-3"
                style="border-bottom: 3px solid #f2f2f2; border-top: 3px solid #f2f2f2; "
              ...
              >
                <div class="col-md-1">
                  <img
                    ...
                    src="https://res.cloudinary.com/sigtam/image/upload/v1561254612/servicio.cba3967a_bbyvvy.jpg"
                    alt="profile image"
                  />
                </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="d-flex ml-4">
                      ...
                      <p class="text-success font-weight-bold">
                        {{
                          factura.productosAsociados[0].precioVenta *
                            factura.productosAsociados[0].cantidad +
                          ...
                          <div class="col-md-12">
                            <div class="d-flex flex-column">
                              ...
                              <div class="tab-content" id="nav-tabContent">
                                <div
                                  class="tab-pane fade show active mt-3 ml-2"
                                  id="nav-service"
                                  role="tabpanel"
                                ...
                                >
                                  <div class="d-flex flex-column mt-2">
                                    <div class="d-flex">
                                      <p
                                        class="text-dark font-weight-semibold mr-3"
                                      >
                                        Tipo de Servicio:
                                      </p>
                                    ...
                                    <p>
                                      Mecánico
                                      {{
                                        facturaInd.responsableNombre +
                                          " " +
                                          facturaInd.responsableApellidos
                                      }}
                                    </p>
                                  </div>
                                  ...
                                  <div class="d-flex">
                                    <small class="mb-0 mr-2"
                                      >Fecha de Reparación :</small
                                    >
                                    <small
                                      class="Last-responded mr-2 mb-0 text-dark"
                                      >{{ facturaInd.fecha }}</small
                                    >
                                  </div>

                                  <div class="d-flex">
                                    <small class="mb-0 mr-2 "
                                      >Hora de Reparación :</small
                                    >
                                    <small
                                      class="Last-responded mr-2 mb-0 text-dark"
                                      >{{ facturaInd.hora }}</small
                                    >
                                  </div>
                                </div>
                                ...
                                >
                                  <p
                                    class="text-primary font-weight-semibold ml-3 mb-0 no-wrap mt-3"
                                  >
                                  ...
                                  <div class="d-flex flex-column ml-3 mt-2">
                                    ...
                                    <div class="d-flex flex-row">
                                      ...
                                      <p class="text-success">
                                        {{
                                          facturaInd.precioManoObra +
                                            facturaInd.precioManoObra * 0.19
                                        }}
                                      </p>
                                    </div>
                                  </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                      <div style="width:40%;">
                                        <p class="mb-0 text-left">
                                          {{
                                            facturaInd.productosAsociados[0]
                                              .nombre
                                          }}
                                        </p>
                                      </div>
                                      ...
                                      <div style="width:20%;">
                                        <p class="mb-0 text-success text-left">
                                          {{
                                            facturaInd.productosAsociados[0]
                                              .precioVenta *
                                              facturaInd.productosAsociados[0]
                                  ...
                                  >
                                    <h4
                                      class="font-weight-semibold ml-3 mb-0 no-wrap mt-3"
                                    >
                                      Total a Pagar
                                    </h4>
                                    <h4
                                      class="text-success font-weight-semibold ml-3 mb-0 no-wrap mt-3"
                                    >
                                      {{
                                        facturaInd.productosAsociados[0]
                                          .precioVenta *
...
export default {
  ...
  methods: {
    getFacturas() {
      axios.get(`${constants.URL_FACTURAS}`).then(res => {
