  ...
  <div class="container-scroller">
    ...
    >
      ...
      >
        <div class="mt-2 mb-2">
          <img
            src="https://res.cloudinary.com/sigtam/image/upload/v1561254607/logo-ingsistemas.72f77601_zzym9f.jpg"
            alt="logo"
          />
        </div>
        <a class="navbar-brand brand-logo" href="/dashboard"> </a>
          ...
          <li class="nav-item dropdown">
            ...
            >
              <a class="dropdown-item">
                <p class="mt-4 font-weight-normal float-left">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block ">
            ...
            >
              ...
              <img
                ...
                src="https://res.cloudinary.com/sigtam/image/upload/v1561254608/karen.c799db6c_vt72pi.jpg"
                alt="Profile image"
              />
            </a>
            <div
