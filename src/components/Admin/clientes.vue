<template>
  <div class="col-lg-12 grid-margin stretch-card">
      ...
      <div class="card-body">
        <div class="d-flex flex-row justify-content-between">
          ...
          <button
            ...
            @click="cleanData()"
          >
            <i class="mdi mdi-account-plus"></i>Añadir Nuevo Cliente
          </button>
        </div>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr v-for="client in clientes" :key="client.id">
                <td class="py-1">
                  <img
                    src="https://res.cloudinary.com/sigtam/image/upload/v1561255922/propietario_jkwmon.jpg"
                    alt="image"
                  />
                </td>
                ...
                <td>
                  <button
                    ...
                    id="ver"
                    data-toggle="modal"
                    data-target="#modalVehiculos"
                    @click="getVehicleClient(client.id, client.nombre)"
                  >
                  ...
                  <button
                    ...
                    id="borrar"
                    @click="deleteClient(client._id, client.id)"
                  >
                ...
                <div class="card-body">
                  <form class="forms-sample" @submit.prevent="editClient()">
                    ...
                    <button type="submit" class="btn btn-primary btn-fw">
                      <i class="mdi mdi-file-document"></i>Guardar Cambios
                    </button>
                            ...
                            <div class="col-md-12 mt-4">
                              ...
                              >
                                ...
                                <button
                                  ...
                                  class="btn btn-primary btn-fw"
                                >
                                  <i class="mdi mdi-file-document"></i>Guardar
                                  Datos del Vehiculo
                                </button>
                              </div>
                            </div>
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="modalVehiculos"
      aria-hidden="true"
    >
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title ml-3" id="modalVehiculos">
              Vehiculos de {{ nombrePropietario }}
            </h4>
            <button
              type="button"
              class="close"
                ...
                <div class="card-body">
                  <template v-if="!editing">
                    <div class="d-flex flex-row justify-content-center">
                      <img
                        src="https://res.cloudinary.com/sigtam/image/upload/v1561254608/icono-auto-2.ae1a4670_oqsf85.jpg"
                        alt="auto"
                    ...
                    <div class="row ticket-card mt-3 border-bottom mb-3">
                      <div class="ticket-details col-md-12">
                        <div class="d-flex justify-content-start ">
                          <h5 class="text-dark font-weight-semibold ml-3">
                            {{ datosCarro.marcaActCarro }}
                            {{ datosCarro.modeloActCarro }}
                          </h5>
                        </div>

                        <div
                          class="d-flex justify-content-around align-content-around mt-3"
                        >
                          <div class="d-column justify-content-center">
                            <p class="text-primary mr-2">
                              <span class="font-weight-semibold">Placa:</span>
                              [{{ datosCarro.placaActCarro }}]
                            </p>
                            <p class="text-dark mr-2">
                              <span class="font-weight-semibold"
                                >Kilometraje:</span
                              >
                              {{ datosCarro.kilometrajeActCarro }}
                            </p>
                            <p class="text-dark">
                              <span class="font-weight-semibold">Año:</span>
                              {{ datosCarro.anioActCarro }}
                            </p>
                          </div>
                          ...
                          <div class="d-column justify-content-center">
                            <p class="text-dark mr-2">
                              ...
                              {{ datosCarro.colorActCarro }}
                            </p>
                            <p class="text-dark mr-2">
                              <span class="font-weight-semibold">Motor:</span>
                              {{ datosCarro.motorActCarro }}
                            </p>
                            <p class="text-dark">
                              <span class="font-weight-semibold"
                                >Marca Llantas:</span
                              >
                              {{ datosCarro.marcaActllantasCarro }}
                            </p>
                          </div>
                        </div>
                        <div
                        ...
                        >
                          <button
                            type="button"
                            @click="editDataVehicle()"
                            class="btn btn-primary btn-fw"
                          >
                            <i class="mdi mdi-pencil"></i>Editar Datos
                          </button>
                        </div>
                      </div>
                    </div>
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input
                                  type="text"
                                  class="form-control"
                                  v-model="borradorkilometrajeCarro"
                                />
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input
                                  type="text"
                                  class="form-control"
                                  v-model="borradormarcallantasCarro"
                                />
                              </div>
                            </div>
                          </div>
...
export default {
  ...
  data() {
    return {
      ...
      borradormodeloCarro: "",
      borradorplacaCarro: "",
      borradorkilometrajeCarro: "",
      borradoranioCarro: "",
      borradorcolorCarro: "",
      borradormotorCarro: "",
      borradormarcallantasCarro: "",
      nombrePropietario: "",
      idClientVehicle: "",
      editing: false,
      addCar: false,
  ...
  methods: {
    ...
    getClient(id) {
      axios.get(`${constants.URL_CLIENTES}/${id}`).then(res => {
    ...
    editClient() {
      axios
        .put(`${constants.URL_CLIENTES}/${this.idClientToEdit}`, {
          nombre: this.nombres,
    ...
    deleteClient(idClient, idVehicle) {
      Swal.fire({
        ...
        if (result.value) {
          axios.delete(`${constants.URL_CLIENTES}/${idClient}`).then(res => {
            this.getClients();
            console.log(res.data);
    ...
    getVehicleClient(idClient, clientName) {
      axios.get(`${constants.URL_VEHICULOS}/${idClient}`).then(res => {
