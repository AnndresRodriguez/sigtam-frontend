...
<div class="modal-body">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="inputNombreProducto" placeholder=""  required v-model="getProducto.nombre">
        </div>
        <div class="form-group col-md-3">
          <label for="inputPrecioProducto">Precio/Venta</label>
          <input type="text" class="form-control" id="inputPrecioProducto" placeholder="" required v-model="getProducto.precioVenta">
        </div>
        <div class="form-group col-md-3">
          <label for="inputPrecio">Precio/Compra</label>
          <input type="text" class="form-control" id="inputPrecio" placeholder="" required v-model="getProducto.precioCompra">
        </div>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control" id="inputNombreMarca" placeholder=""  required v-model="getProducto.marca">
        </div>
        <div class="form-group col-md-4">
          <label for="inputUnidadProducto">Unidad</label>
          <input type="text" class="form-control" id="inputUnidadProducto" placeholder="Litro, Galón, Caja" required v-model="getProducto.unidadDeMedida">
        </div>
         <div class="form-group col-md-2">
          <label for="inputCantidad">Cantidad</label>
          <input type="text" class="form-control" id="inputCantidad" placeholder="" required v-model="getProducto.cantidadEnStock">
        </div>
      </div>  
...
export default {
    ...
    methods:{
      ...
      editarProducto(){
         ...
         axios
         .put(`${constants.URL_PRODUCTOS}/${this.indiceCategoria}`, this.$store.getters.getCurrentProduct, {
